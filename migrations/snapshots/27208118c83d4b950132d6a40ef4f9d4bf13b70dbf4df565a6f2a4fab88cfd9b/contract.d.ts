...
export type StorageHash =
  StorageHashBase<'27208118c83d4b950132d6a40ef4f9d4bf13b70dbf4df565a6f2a4fab88cfd9b'>;
        ...
        readonly entries: {
          readonly table: {
            readonly Category: {
              ...
              indexes: readonly [
                {
                  readonly name: 'Category_createdAt_idx';
                ...
                {
                  readonly name: 'Category_slug_idx';
            ...
            readonly Horoscope: {
              ...
              primaryKey: { readonly columns: readonly ['id']; readonly name: 'Horoscope_pkey' };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'Horoscope_date_idx';
                  readonly columns: readonly ['date'];
                  readonly unique: false;
                },
                {
                  readonly name: 'Horoscope_zodiacSign_date_key';
                  readonly columns: readonly ['zodiacSign', 'date'];
                  readonly unique: true;
                },
              ];
              foreignKeys: readonly [];
            ...
            readonly PastEvent: {
              ...
              primaryKey: { readonly columns: readonly ['id']; readonly name: 'PastEvent_pkey' };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'PastEvent_category_idx';
                  readonly columns: readonly ['category'];
                  readonly unique: false;
                },
                {
                  readonly name: 'PastEvent_eventDate_idx';
                  readonly columns: readonly ['eventDate'];
                  readonly unique: false;
                },
                {
                  readonly name: 'PastEvent_month_day_category_idx';
                  readonly columns: readonly ['month', 'day', 'category'];
                  readonly unique: false;
                },
                {
                  readonly name: 'PastEvent_month_day_idx';
                  readonly columns: readonly ['month', 'day'];
                  readonly unique: false;
                },
                {
                  readonly name: 'PastEvent_month_day_year_slug_key';
                  readonly columns: readonly ['month', 'day', 'year', 'slug'];
                  readonly unique: true;
                },
                {
                  readonly name: 'PastEvent_slug_idx';
                  readonly columns: readonly ['slug'];
                  readonly unique: false;
                },
              ];
            ...
            readonly Question: {
              ...
              primaryKey: { readonly columns: readonly ['id']; readonly name: 'Question_pkey' };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'Question_quizId_idx';
              ...
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'Question_quizId_fkey';
                },
              ];
            };
            readonly Quiz: {
              ...
              primaryKey: { readonly columns: readonly ['id']; readonly name: 'Quiz_pkey' };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'Quiz_createdAt_idx';
                  readonly columns: readonly ['createdAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'Quiz_difficulty_idx';
                  readonly columns: readonly ['difficulty'];
                  readonly unique: false;
                },
                {
                  readonly name: 'Quiz_isPublished_idx';
                  readonly columns: readonly ['isPublished'];
                  readonly unique: false;
                },
                {
                  readonly name: 'Quiz_quizPageTitle_key';
                  readonly columns: readonly ['quizPageTitle'];
                  readonly unique: true;
                },
                {
                  readonly name: 'Quiz_slug_idx';
                  readonly columns: readonly ['slug'];
                  readonly unique: false;
                },
                {
                  readonly name: 'Quiz_slug_key';
                  readonly columns: readonly ['slug'];
                  readonly unique: true;
                },
              ];
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'Quiz_categoryId_fkey';
                },
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                  ...
                  readonly name: 'Quiz_subCategoryId_fkey';
                },
              ];
            };
            readonly QuizTag: {
              ...
              primaryKey: {
                readonly columns: readonly ['quizId', 'tagId'];
                readonly name: 'QuizTag_pkey';
              };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'QuizTag_quizId_idx';
                  readonly columns: readonly ['quizId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  ...
                  readonly name: 'QuizTag_quizId_fkey';
                },
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                  ...
                  readonly name: 'QuizTag_tagId_fkey';
                },
              ];
            };
            readonly SubCategory: {
              ...
              indexes: readonly [
                {
                  readonly name: 'SubCategory_categoryId_idx';
                  readonly columns: readonly ['categoryId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'SubCategory_categoryId_name_key';
                  readonly columns: readonly ['categoryId', 'name'];
                  readonly unique: true;
                },
                {
                  readonly name: 'SubCategory_slug_idx';
                  readonly columns: readonly ['slug'];
                  readonly unique: false;
                },
              ];
            ...
            readonly Tag: {
              ...
              primaryKey: { readonly columns: readonly ['id']; readonly name: 'Tag_pkey' };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'Tag_name_idx';
                  readonly columns: readonly ['name'];
                  readonly unique: false;
                },
                {
