/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 477eb5916308729b7640aa865ff07c8a)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		GENERATE_QUIZ: Workflow<Parameters<import("./src/index").GenerateQuizWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BASE_URL" | "DATABASE_URL" | "NEXT_PUBLIC_URL" | "OPENAI_API_KEY" | "OPENAI_BASE_URL" | "OPENAI_MODEL" | "ADMIN_PASSWORD" | "ADMIN_SESSION_SECRET">> {}
}
